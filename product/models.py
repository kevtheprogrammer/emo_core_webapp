...
class Product(models.Model):
    ...
    location_city = models.ForeignKey(City, on_delete=models.CASCADE, related_name="products", default=None, null=True)
    ...
    seller = models.ForeignKey(User, on_delete=models.CASCADE, related_name="products", default=None, null=True,)
    img1 = models.ImageField(upload_to="products/images/", blank=True, null=True, verbose_name="first image")
    img2 = models.ImageField(upload_to="products/images/", blank=True, null=True, verbose_name="second image")
    img3 = models.ImageField(upload_to="products/images/", blank=True, null=True, verbose_name="third image")
    tags = models.ManyToManyField(Tag, related_name="products", null=True)
    colors = models.ManyToManyField(Color, related_name="products" ,null=True)
